...
def prototype_twitter_HRED():
    ...
    state['train_dialogues'] = "./Output/train.dialogues.pkl"
    state['test_dialogues'] = "./Output/test.dialogues.pkl"
    state['valid_dialogues'] = "./Output/valid.dialogues.pkl"
    state['dictionary'] = "./Output/train.dict.pkl"
    state['save_dir'] = "./Output"
    ...
    state['bs'] = 30 # If out of memory, modify this!
...
def prototype_UBUNTU_HRED():
    ...
    # Fill your paths here!
    state['train_dialogues'] = "./ubuntu_data/Train.dialogues.pkl"
    state['test_dialogues'] = "./ubuntu_data/Test.dialogues.pkl"
    state['valid_dialogues'] = "./ubuntu_data/Valid.dialogues.pkl"
    state['dictionary'] = "./ubuntu_data/Dataset.dict.pkl"
    state['save_dir'] = "./ubuntu_data/"
...
def prototype_twitter_VHRED():
    ...
    state['prefix'] = "TwitterModel_VHRED_"
    state['updater'] = 'adam'
...
def prototype_ubuntu_HRED():
    ...
    state['train_dialogues'] = "./ubuntu_data/Train.dialogues.Single.pkl"
    state['test_dialogues'] = "./ubuntu_data/Test.dialogues.Single.pkl"
    state['valid_dialogues'] = "./ubuntu_data/Valid.dialogues.Single.pkl"
    state['dictionary'] = "./ubuntu_data/Dataset.dict.pkl"
    state['save_dir'] = "./ubuntu_data/"
...
def prototype_ubuntu_VHRED():
    ...
    state['prefix'] = "UbuntuModel_VHRED"
    state['updater'] = 'adam'
...
def prototype_tieba_VHRED():
    state = prototype_state()
    state['end_sym_utterance'] = '<end>'
    # Fill your paths here!
    state['train_dialogues'] = "../data/tieba/train.dialogues.pkl"
    state['test_dialogues'] = "../data/tieba/test.dialogues.pkl"
    state['valid_dialogues'] = "../data/tieba/valid.dialogues.pkl"
    state['dictionary'] = "../data/tieba/dict.pkl"
    state['save_dir'] = "./tieba"

    state['max_grad_steps'] = 80

    state['valid_freq'] = 5000

    state['prefix'] = "TiebaModel_VHRED_"
    state['updater'] = 'adam'
