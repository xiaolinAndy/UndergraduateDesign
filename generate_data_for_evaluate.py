...
tieba_context = open('./tieba/evaluate.contexts.txt', 'r', encoding='utf-8').readlines()
...
tieba_tfidf_response = open('./tieba/evaluate.tfidf.responses.txt', 'r', encoding='utf-8').readlines()
...
tieba_dual_encoder_response = open('./tieba/evaluate.dual_encoder.responses.txt', 'r', encoding='utf-8').readlines()
...
tieba_VHERD_response = open('./tieba/evaluate.VHERD.responses.txt', 'r', encoding='utf-8').readlines()

response_order = list(range(1500))
...
tieba_response = tieba_tfidf_response + tieba_dual_encoder_response + tieba_VHERD_response
...
for i in range(1):
    ...
    task2 = open('./data/task2_' + str(i + 1), 'wb')
